          ...
          <form action={loginStaff} className="form-grid">
            ...
            <div className="actions">
              ...
              <details className="inline-details">
                <summary className="btn secondary">Forgot password?</summary>
                <div className="edit-popover auth-popover">
                  ...
                  <form action={requestPasswordReset} className="form-grid">
                    <div className="field full"><label>Staff email</label><input name="email" type="email" required /></div>
